...
#define DAC12_RSTCTL_RESETSTKYCLR_CLR   0x00000002U /* !< Clear reset sticky bit */
#define DAC12_RSTCTL_RESETASSERT_ASSERT 0x00000001U /* !< Assert reset */
...
#define DAC12_CTL0_ENABLE_SET  0x00000001U /* bit 0: DAC on */
#define DAC12_CTL0_ENABLE_MASK 0x00000001U
#define DAC12_CTL0_RES_MASK    0x00000100U /* bit 8: resolution select */
#define DAC12_CTL0_RES__8BITS  0x00000000U
#define DAC12_CTL0_RES__12BITS 0x00000100U
#define DAC12_CTL0_DFM_MASK    0x00010000U /* bit 16: data format (binary vs 2s-comp) */
#define DAC12_CTL0_DFM_BINARY  0x00000000U

/* CTL1 — output amplifier, voltage reference, and output pin routing */
#define DAC12_CTL1_AMPEN_MASK      0x00000001U
#define DAC12_CTL1_AMPEN_ENABLE    0x00000001U /* bit 0: amplifier enable */
#define DAC12_CTL1_AMPHIZ_MASK     0x00000002U /* bit 1: amp-off output state */
#define DAC12_CTL1_AMPHIZ_PULLDOWN 0x00000002U /* pull DAC_OUT to 0 V when amp is off */
#define DAC12_CTL1_REFSP_MASK      0x00000100U /* bit 8: positive reference select */
#define DAC12_CTL1_REFSP_VDDA      0x00000000U /* use VDDA as VR+ */
#define DAC12_CTL1_REFSP_VEREFP    0x00000100U /* use VEREFP pin as VR+ */
#define DAC12_CTL1_REFSN_MASK      0x00000200U /* bit 9: negative reference select */
#define DAC12_CTL1_REFSN_VEREFN    0x00000000U /* use VEREFN pin as VR- */
#define DAC12_CTL1_REFSN_VSSA      0x00000200U /* use VSSA as VR- */
...
#define DAC12_GEN_EVENT_RIS_MODRDYIFG_SET 0x00000002U /* bit 1: DAC core is ready */

/* DATA0 — the value written here appears on the DAC output */
#define DAC12_DATA0_DATA_VALUE_MASK 0x00000FFFU /* bits [11:0]: 12-bit data field */
#endif
				   ...
				   const struct dac_channel_cfg *channel_cfg)
{
	...
	if (channel_cfg->buffered) {
		...
		while (regs->CALCTL & DAC12_CALCTL_CALON_ACTIVE) {
			/* spin: hardware clears CALON when calibration completes */
		}
	}
